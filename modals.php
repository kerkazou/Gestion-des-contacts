...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="container" method="POST" action="add_contact.php" data-parsley-validate>
                <div class="modal-body">
                    <div class="form-floating mb-3">
                        <input class="form-control mb-3" name="username" type="text" id="floatingInput" placeholder="name@example.com" required data-parsley-minlength="3">
                        <label for="floatingInput">Username</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input class="form-control mb-3" name="phone"type="text" id="floatingInput" placeholder="name@example.com" required data-parsley-length="[10]">
                        <label for="floatingInput">Phone</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input class="form-control mb-3" name="email" type="text" id="floatingInput" placeholder="name@example.com" required data-parsley-type="email">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                ...
                <form method="POST" class="container" action="edite_contact.php" data-parsley-validate>
                    <div class="modal-body">
                        <input class="form-control mb-3 id" name="idc" type="hidden">
                        <div class="form-floating mb-3">
                            <input class="form-control mb-3 username" name="username_e" type="text" required id="floatingInput" placeholder="name@example.com" required data-parsley-minlength="3">
                            <label for="floatingInput">Username</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control mb-3 phone"  name="phone_e"type="text" required id="floatingInput" placeholder="name@example.com" required data-parsley-length="[10,10]">
                            <label for="floatingInput">Phone</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control mb-3 email"  name="email_e" type="text" required id="floatingInput" placeholder="name@example.com" required data-parsley-type="email">
                            <label for="floatingInput">Adress email</label>
                        </div>
                        <div class="form-floating">
