...
const validation_sign_in = document.getElementById('validation_sign_in');
const pattern_email = /[a-z0-9]+@[a-z]+\.[a-z]{2,3}/;

validation_sign_in.addEventListener('click', (e) => {
...
const validation_sign_up = document.getElementById('validation_sign_up');
const pattern_username = /[a-zA-Z]/;
validation_sign_up.addEventListener('click', (e)=> {
